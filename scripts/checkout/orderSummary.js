import {cart,removeFromcart,checkoutquantity,updateQuantity,displaycart,updateDeliveryOption} from '../../data/cart.js';
...
checkoutquantity();
    ...
    document.querySelectorAll('.js-update-link').forEach((link)=>{
      link.addEventListener('click',()=>{
        ...
        const inputValue=document.querySelector(`.js-input-${productId
        }`);
        inputValue.value='';
